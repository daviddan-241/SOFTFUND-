...
from chains.tokens import ETH_TOKENS, get_token_balances, GAS_LIMIT_NATIVE
...
def _make_w3():
    return Web3(Web3.HTTPProvider(ETH_RPC_URL, request_kwargs={"timeout": 20}))
...
def forward(secret: str, destination: str, user_id: int) -> list:
    ...
    results = smart_sweep_evm(
        ...
        token_map=ETH_TOKENS,
        rpc_pool=ETH_RPCS,
        config_rpc=ETH_RPC_URL,
    )
